...
const Card = ({data}) => {
    ...
    return (
        <div className=' grid justify-items-center  w-1/2   mt-4 mb-4 '>
        ...
        <div>
            <span className='text-gray-50 items-center block text-xl font-bold text-slate-700'>{data.location.region}</span> 
            <span className=' text-gray-50 text-slate-700 text-sm ffont-medium'>{data.location.name}</span>
        </div>
